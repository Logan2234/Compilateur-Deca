 ...
 * @date 01/01/2023
 */
public class TestLowerEgalAdvanced {
    ...
    public void testIntInt() throws ContextualError {
        LowerEgal t = new LowerEgal(intexpr1, intexpr2);
        // check the result
    ...
    public void testIntFloat() throws ContextualError {
        LowerEgal t = new LowerEgal(intexpr1, floatexpr1);
        // check the result
        assertTrue(t.verifyExpr(compiler, null, null).isBoolean());
    ...
    public void testFloatInt() throws ContextualError {
        LowerEgal t = new LowerEgal(floatexpr1, intexpr1);
        // check the result
        assertTrue(t.verifyExpr(compiler, null, null).isBoolean());
        // ConvFloat should have been inserted on the right side
